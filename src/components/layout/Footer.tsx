        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          <div className="col-span-2 lg:col-span-2">
            <Link href="/" className="flex items-center gap-1 mb-4">
              <Image src={logoNav} alt="ScriptNex Logo" className="h-[48px] md:h-[54px] w-auto object-contain" />
            </Link>
          ...
          <div className="flex gap-4">
            {[
              ...
              <a 
                ...
                className="w-12 h-12 rounded-full bg-[#d1d5db] flex items-center justify-center transition-all hover:scale-110 hover:bg-white shadow-xl shadow-black/40"
              >
