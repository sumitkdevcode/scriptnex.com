        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12 mb-8">
          <div className="col-span-2 lg:col-span-2 flex flex-col items-start">
            <Link href="/" className="mb-6">
              <Image src="/logo-nav.png" alt="ScriptNex — Free Online Coding Platform" width={180} height={60} className="h-[64px] md:h-[72px] w-auto object-contain" style={{ width: 'auto' }} />
            </Link>
