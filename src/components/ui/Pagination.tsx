  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-6">
      <button
        ...
        className="p-2 rounded-lg bg-[#1a1c23] border border-[#2a2d35] text-[#ababab] hover:border-[#00d285]/30 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
      ...
      <div className="flex items-center gap-1.5">
        {rangeWithDots.map((page, i) => (
          <React.Fragment key={i}>
            {page === '...' ? (
              <span className="px-2 text-[#ababab]">...</span>
            ) : (
              <button
