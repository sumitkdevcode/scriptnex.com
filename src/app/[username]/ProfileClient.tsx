          ...
          <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-6">
            <div className="flex gap-4 items-center mb-4">
              {profile.avatar ? (
                ...
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#00d285] to-[#00a669] flex items-center justify-center text-2xl font-bold text-black shrink-0" role="img" aria-label={`${profile.name} avatar`}>
