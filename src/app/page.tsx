    ...
    <div className="min-h-screen flex flex-col bg-[#0f1115] text-[#f8fafc] overflow-hidden">
      ...
      <section className="relative z-10 border-t border-[#2a2d35] py-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#ababab] text-sm text-center mb-10 max-w-xl mx-auto">From beginner to expert, ScriptNex has tools for every stage of your coding journey.</p>
      ...
      <section className="relative z-10 py-20 px-6 bg-[#16181d] border-t border-[#2a2d35]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#ababab] max-w-xl mx-auto">Follow a structured approach to land your dream role.</p>
          </div>
      ...
      <section className="relative z-10 py-16 px-6 border-t border-[#2a2d35]">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs font-semibold text-[#ababab] uppercase tracking-widest mb-8">Developers from top companies train here</p>
