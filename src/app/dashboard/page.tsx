...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-4 pb-6 w-full flex flex-col gap-4">

      {/* Top row: Solved + Calendar + Streak */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">

        {/* Solved Problems Donut */}
        <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 flex items-center gap-4">
          <div className="relative w-[90px] h-[90px] shrink-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-lg font-bold leading-none">{totalSolved}</span>
              <span className="text-[9px] text-[#ababab] mt-0.5">/{3920}</span>
        ...
        {/* Badges / Certificates */}
        <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 flex flex-col">
        ...
        {/* Streak & Quick Stats */}
        <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 flex flex-col gap-3">
      ...
      {/* Activity Heatmap */}
      <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          {certificates.length > 0 && (
            <div className="bg-[#1a1c23] border border-[#2a2d35] rounded-md overflow-hidden">
              <div className="flex border-b border-[#2a2d35] bg-[#16181d] px-4 py-2">
        ...
        <div className="flex flex-col gap-2">
          <Link href="/problems" className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 hover:border-[#00d285]/20 transition-all group block">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-md bg-[#00d285]/10 flex items-center justify-center text-base">⌨️</div>
              <h3 className="font-semibold text-sm group-hover:text-[#00d285] transition-colors">Solve a Problem</h3>
            </div>
            <p className="text-xs text-[#ababab] pl-11">Pick a challenge and start coding</p>
          </Link>
          <Link href="/contests" className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 hover:border-[#f59e0b]/20 transition-all group block">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-md bg-[#f59e0b]/10 flex items-center justify-center text-base">🏆</div>
              <h3 className="font-semibold text-sm group-hover:text-[#f59e0b] transition-colors">Join a Contest</h3>
            </div>
            <p className="text-xs text-[#ababab] pl-11">Compete with developers worldwide</p>
          </Link>
          <Link href="/certifications" className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 hover:border-[#a855f7]/20 transition-all group block">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-md bg-[#a855f7]/10 flex items-center justify-center text-base">📜</div>
              <h3 className="font-semibold text-sm group-hover:text-[#a855f7] transition-colors">Get Certified</h3>
            </div>
            <p className="text-xs text-[#ababab] pl-11">Earn verified credentials</p>
          </Link>
          <Link href={user?.username ? `/${user.username}` : '#'} className="bg-[#1a1c23] border border-[#2a2d35] rounded-md p-4 hover:border-[#3b82f6]/20 transition-all group block">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 rounded-md bg-[#3b82f6]/10 flex items-center justify-center text-base">👤</div>
              <h3 className="font-semibold text-sm group-hover:text-[#3b82f6] transition-colors">My Profile</h3>
            </div>
            <p className="text-xs text-[#ababab] pl-11">View your public profile</p>
          </Link>
        </div>
      </div>
    </div>
