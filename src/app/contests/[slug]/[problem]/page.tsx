    ...
    <div className="h-screen flex flex-col bg-[#0f1115] text-[#f8fafc] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-[#2a2d35] bg-[#16181d] shrink-0">
        <div className="flex items-center gap-3">
          <Link href={`/contests/${contestSlug}`} className="text-[#94a3b8] hover:text-white transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 18l-6-6 6-6"/></svg>
          </Link>
          <div className="flex items-center gap-2">
            <span className="font-semibold text-xs uppercase tracking-wider text-[#64748b]">Contest Workspace</span>
            ...
            {activeTab === 'description' ? (
              ...
              <div className="text-sm text-[#cbd5e1]">
                {problem.editorial ? (
                  ...
                  <p className="text-[#64748b]">Editorial not available during contest.</p>
                )}
              </div>
            )}
          </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 bg-[#0f1115]">
              {resultTab === 'testcases' ? (
                <div className="space-y-3">
                  {sampleCases.map((sc, idx) => (
                    <div className="bg-[#16181d] border border-[#2a2d35] rounded-lg p-3" key={sc.id}>
