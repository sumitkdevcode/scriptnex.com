...
export default function SheetsClient({ initialSheets }: SheetsClientProps) {
  const [sheets] = useState<Sheet[]>(initialSheets);
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-12">
        ...
        {sheets.length === 0 && (
          <div className="text-center py-20 text-[#ababab]">
            <p>No coding sheets available yet. Check back soon!</p>
          </div>
        )}
      </main>
      <Footer />
