    ...
    return (
      <div className="min-h-screen bg-[#0f1115] text-[#f8fafc]">
        ...
        <div className="max-w-3xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-[#94a3b8] mb-6">This certification is unavailable right now.</p>
          <Link href="/certifications" className="px-6 py-3 bg-[#00d285] text-black font-semibold rounded-xl">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <div key={stat.label} className="bg-[#16181d] border border-[#2a2d35] rounded-xl p-4 text-center">
              <div className="text-xs text-[#64748b] uppercase tracking-wider mb-1">{stat.label}</div>
        ...
        <button
          onClick={handleStart}
          disabled={isLoading}
          className="px-8 py-4 bg-[#00d285] text-black font-bold rounded-xl text-lg hover:bg-[#00e691] transition-colors w-full disabled:opacity-50"
        >
