  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-[#f8fafc]">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-6">
        ...
        <p className="text-[#94a3b8] text-sm mb-4">Earn verified certificates and prove your skills to employers</p>
        {loading ? (
          ...
          <>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
              {certs.map(cert => (
                <Link key={cert.id} href={`/certifications/${cert.slug}`} className="bg-[#16181d] border border-[#2a2d35] rounded-xl overflow-hidden hover:border-[#00d285]/20 transition-all group block">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-[12px] text-[#94a3b8] mb-4 line-clamp-2 leading-relaxed">{cert.description}</p>
              ...
              {certs.length === 0 && <div className="text-center py-20 text-[#64748b] col-span-full">No certifications found.</div>}
            </div>
